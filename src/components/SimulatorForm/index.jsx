...
export default function SimulatorForm() {
  ...
  function simulate() {
    ...
    if (
      yieldButton === "liquidoActive" &&
      indexingTypesButton === "preActive"
    ) {
      changeSimulatorInfo(yieldButton, indexingTypesButton);
    }
    ...
    if (
      yieldButton === "liquidoActive" &&
      indexingTypesButton === "fixedActive"
    ) {
      changeSimulatorInfo(yieldButton, indexingTypesButton);
    }

    if (
      yieldButton === "brutoActive" &&
      indexingTypesButton === "fixedActive"
    ) {
      changeSimulatorInfo(yieldButton, indexingTypesButton);
    }
  ...
  return (
    <div className="formInputs">
      ...
      <div className="content">
        <div className="leftSimulatorContent" style={{ marginRight: "10px" }}>
          ...
          <div className="flexButton">
            <button
              className={
                yieldButton === "brutoActive" ? "isActive" : "formButton"
              }
              onClick={() => setYieldButton("brutoActive")}
              style={{ borderRadius: "4px 0px 0px 4px", width: "100%" }}
            >
              Bruto
            </button>
            <button
              className={
                yieldButton === "liquidoActive" ? "isActive" : "formButton"
              }
              onClick={() => setYieldButton("liquidoActive")}
          ...
          <div className="labelFields">Aporte Inicial</div>
          ...
          <div className="labelFields">Prazo (em meses)</div>

          <CurrencyFormat
            className="inputMaxWidth"
            onChange={(e) => setDeadlineInMonths(e.target.value)}
            value={deadlineInMonths}
            placeholder="12"
          />

          <div className="labelFields">IPCA (ao ano)</div>
        ...
        <div className="rightSimulatorContent">
          <div className="divTitleLabelsRight">
            <label className="marginLeftPropToRightSimulatorContent">
              Rendimento{" "}
            </label>
            <img src="https://img.icons8.com/material-outlined/24/000000/info.png" />
          </div>
          ...
          <div className="flexButtonWithJustifyContent">
            <button
              ...
              onClick={() => setIndexingTypesButton("preActive")}
            ...
            <button
              className={
                indexingTypesButton === "posActive" ? "isActive" : "formButton"
              }
              onClick={() => setIndexingTypesButton("posActive")}
            >
              PÓS
            </button>
            <button
              ...
              onClick={() => setIndexingTypesButton("fixedActive")}
      ...
      <div className="buttonsForm">
        <button className="cleanFieldsButton" onClick={() => cleanAllFields()}>
          {" "}
          limpar Campos{" "}
        </button>
        <button className="simulationButton" onClick={() => simulate()}>
          {" "}
          Simular
        </button>
      </div>
